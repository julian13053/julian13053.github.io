            ...
            <div class="grid gap-4">
                ...
                <div class="flex items-center gap-5 bg-gray-50 p-5 rounded-2xl border border-gray-100 shadow-xs">
                    ...
                    <div>
                        ...
                        <a href="mailto:julian@fleger.de" class="text-gray-900 font-extrabold text-xl hover:text-blue-600 transition-colors">julian@fleger.de</a>
                    </div>
                </div>
